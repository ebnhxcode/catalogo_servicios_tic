<div class="tab-pane fade show active" id="v-pills-aplicaciones" role="tabpanel" aria-labelledby="v-pills-aplicaciones-tab">
   ...
   <h3>REGISTRAR UNA NUEVA APLICACIÓN EN EL SERVIDOR</h3>
   <div class="card">
      ...
      <div class="card-body pro">
         ...
         <div class="row">
            ...
            <div class="col-sm-3 col-md-3">
               ...
               <dd>
                  <p class="control has-icon has-icon-right">
                     <input type="text" v-model="aplicacion.ip=servidor.ip_servidor" name="ip"
      ...
      <div class="card-body pro">
         ...
         <div class="row">
            ...
            <div class="col-sm-4 col-md-4">
               ...
               <dd>
                  <p class="control has-icon has-icon-right">
                     <select class="form-control" v-model="aplicacion.id_servidor=servidor.id_servidor" name="id_servidor"
