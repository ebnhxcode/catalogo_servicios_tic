...
@section('content')
   ...
   <main role="main" class="col-md-9 ml-sm-auto col-lg-9 {{--pt-3 px-4--}}" id="{{$nombre_controller}}">
      ...
      <div class="card-columns {{--card-deck--}}" v-if="mantenedores && mantenedores.length > 0">

         <div class="card bg-dark text-white border-light mb-3" v-for="m in filterBy(mantenedores, filtro_head)">
