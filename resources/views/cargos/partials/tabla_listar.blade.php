<table class="table table-striped table-hover table-sm">
   ...
   <tbody>
   <tr v-for="c in filterBy(cargos, filtro_head)"
       @dblclick.prevent="editar(p.id_cargo)">

      <template v-if="id_en_edicion != p.id_cargo || modal_actualizar_activo == true">
      ...
      <template v-else>
         <td>
            <span v-clipboard="p.id_cargo" class="btn btn-light"
      ...
      <td>
         <button class="btn btn-sm btn-primary"
                 v-show="id_en_edicion != p.id_cargo && id_en_edicion == null && modal_actualizar_activo == false"
                 data-placement="top" data-toggle="tooltip" title="Editar desde aquí"
                 @click.prevent="editar(p.id_cargo)">
            <i class="fa fa-edit"></i>
         </button>
         <button class="btn btn-sm btn-success" v-show="id_en_edicion == p.id_cargo && modal_actualizar_activo == false"
         ...
         <button class="btn btn-sm btn-secondary"
                 ...
                 v-show="dejar_de_editar_contador>2 && id_en_edicion == p.id_cargo">
            <i class="fa fa-close"></i>
         </button>
