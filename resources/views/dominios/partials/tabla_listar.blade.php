<table class="table table-striped table-hover table-sm">
   ...
   <tbody>
   <tr v-for="d in filterBy(dominios, filtro_head)"
       @dblclick.prevent="editar(d.id_dominio)">

      <template v-if="id_en_edicion != d.id_dominio || modal_actualizar_activo == true">
      ...
      <template v-else>
         <td>
            <span v-clipboard="d.id_dominio" class="btn btn-light"
                  data-placement="top" data-toggle="tooltip" title="Clic para copiar el id">
               Id dominio: @{{ d.id_dominio }}
            </span>
         </td>
      ...
      <td>
         <button class="btn btn-sm btn-primary"
                 v-show="id_en_edicion != d.id_dominio && id_en_edicion == null && modal_actualizar_activo == false"
                 data-placement="top" data-toggle="tooltip" title="Editar desde aquí"
                 @click.prevent="editar(d.id_dominio)">
            <i class="fa fa-edit"></i>
         </button>
         <button class="btn btn-sm btn-success" v-show="id_en_edicion == d.id_dominio && modal_actualizar_activo == false"
         ...
         <button class="btn btn-sm btn-secondary"
                 ...
                 v-show="dejar_de_editar_contador>2 && id_en_edicion == d.id_dominio">
            <i class="fa fa-close"></i>
         </button>
   ...
   <tr v-if="dominios && dominios.length == 0 || filterBy(dominios, filtro_head).length == 0">
