...
@section('content')
   ...
   <main role="main" class="col-md-9 ml-sm-auto col-lg-9 pt-3 px-4" id="{{$nombre_controller}}">
            ...
            <div class="input-group input-group-sm">
               ...
               <div class="btn-group mr-0">
                  ...
                  <div class="dropdown-menu">
                     ...
                     <download-excel
                        v-if="(excel_data_contador = filterBy(permisos, filtro_head).length) > 0"
                        :data="filterBy(permisos, filtro_head)"
      ...
      <div class="btn-group btn-group-sm btn-group-toggle" v-for="v,c,i in tabla_permisos_campos">
         <label :class="v==true?'btn btn-primary active':'btn btn-secondary'" @click.prevent="cambiar_visibilidad(c)"
            ...
            <input type="checkbox" autocomplete="off"> <span style="font-size: 85%;">@{{ tabla_permisos_labels[c] }}</span>
         </label>
      </div>
      <br />
      <br />
