...
var UsuarioBitacoraServicioController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'relaciones_clase': [{ 'usuario': ['id_usuario', 'nom_usuario'] }, { 'servicio': ['id_servicio', 'nom_servicio'] }, { 'actividad': ['id_actividad', 'nom_actividad'] }],
         'lom': {},
         'lista_objs_model': [],
         ...
         'tabla_campos': {
            ...
            'asunto': { 'visibility': false, 'value': null },
