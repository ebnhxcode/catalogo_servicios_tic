...
var AplicacionController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_aplicacion', 'det_aplicacion', 'alias', 'url_web', 'ip', 'subdominio', 'ssl_tls', 'id_dominio', 'id_tipo_aplicacion', 'id_servidor', 'id_servicio'],
         'relaciones_clase': [{ 'dominio': ['id_dominio', 'nom_dominio'] }, { 'tipo_aplicacion': ['id_tipo_aplicacion', 'nom_tipo_aplicacion'] }, { 'servicio': ['id_servicio', 'nom_servicio'] }, { 'servidor': ['id_servidor', 'nom_servidor'] }],
         'lom': {},
         'lista_objs_model': [],
         'actividades': [],
         'tipos_aplicaciones': [],
         ...
         'tabla_campos': {
            ...
            'det_aplicacion': { 'visibility': false, 'value': null },
            'alias': { 'visibility': false, 'value': null },
            'url_web': { 'visibility': false, 'value': null },
            'ip': { 'visibility': false, 'value': null },
            'subdominio': { 'visibility': false, 'value': null },
            'ssl_tls': { 'visibility': false, 'value': null },
            //'id_dominio':{'visibility':false,'value':null},
            'nom_dominio': { 'visibility': false, 'value': null },
            //'id_tipo_aplicacion':{'visibility':false,'value':null},
            'nom_tipo_aplicacion': { 'visibility': false, 'value': null },
            //'id_servidor':{'visibility':false,'value':null},
            'nom_servidor': { 'visibility': false, 'value': null },
