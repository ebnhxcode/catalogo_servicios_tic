...
var EstadoController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_estado', 'det_estado', 'cod_estado'],
         'relaciones_clase': [],
         'lom': {},
         'lista_objs_model': [],
         'estados': [],
         ...
         'tabla_campos': {
            ...
            'nom_estado': { 'visibility': true, 'value': null },
            'det_estado': { 'visibility': false, 'value': null },
            'cod_estado': { 'visibility': false, 'value': null },
