...
var ClusterController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'relaciones_clase': [{ 'tipo_cluster': ['id_tipo_cluster', 'nom_tipo_cluster'] }],
         'lom': {},
         'lista_objs_model': [],
         'clusters': [],
   ...
   watch: {
      ...
      clusters: function clusters(_clusters) {
         var self = this;
         this.excel_json_datos = [];
         return _clusters.map(function (cluster, index) {
