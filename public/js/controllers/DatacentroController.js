...
var DatacentroController = new Vue({
   ...
   watch: {
      ...
      datacentros: function datacentros(_datacentros) {
         var self = this;
         this.excel_json_datos = [];
         return _datacentros.map(function (datacentro, index) {
   ...
   methods: {
      ...
      inicializar: function inicializar() {
         ...
         this.$http.get('/datacentros').then(function (response) {
            // success callback
            _this.datacentros = response.body.datacentros || null;
            _this.datos_excel = response.body.datacentros || null;
      ...
      editar: function editar(id_datacentro) {
      ...
      guardar_editado: function guardar_editado() {
         ...
         this.$http.put('/' + this.nombre_ruta + '/' + this.datacentro.id_datacentro, this.datacentro).then(function (response) {
            // success callback

            if (response.status == 200) {
               if (!_this2.es_null(response.body.datacentro)) {
      ...
      eliminar: function eliminar(id_datacentro) {
         var _swal,
             _this3 = this;
         ...
         __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()((_swal = {
            ...
            if (result.value) {
               ...
               _this3.$http.delete('/' + _this3.nombre_ruta + '/' + id_datacentro).then(function (response) {
                  if (response.status == 200) {
      ...
      ordenar_lista: function ordenar_lista(columna) {
         this.datacentros = _.orderBy(this.datacentros, columna, this.orden_lista);
      }
