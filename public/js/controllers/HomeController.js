...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__libs_HelperPackage__ = __webpack_require__(1);
//require('../bootstrap');
...
var HomeController = new Vue({
   ...
   methods: {
      ...
      ordenar_lista: function ordenar_lista(columna) {
         this.home_items = _.orderBy(this.home_items, columna, this.orden_lista);
      }
