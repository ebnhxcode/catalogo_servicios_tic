...
var TipoRespaldoDiscoController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_tipo_respaldo_disco', 'det_tipo_respaldo_disco', 'cod_tipo_respaldo_disco'],
         'relaciones_clase': [],
         'lom': {},
         'lista_objs_model': [],
         ...
         'tabla_campos': {
            'id_tipo_respaldo_disco': { 'visibility': false, 'value': null },
            'nom_tipo_respaldo_disco': { 'visibility': true, 'value': null },
            'det_tipo_respaldo_disco': { 'visibility': false, 'value': null },
            'cod_tipo_respaldo_disco': { 'visibility': false, 'value': null },
   ...
   watch: {
      ...
      tipos_respaldos_discos: function tipos_respaldos_discos(_tipos_respaldos_discos) {
         var self = this;
         this.excel_json_datos = [];
         return _tipos_respaldos_discos.map(function (tipo_respaldo_disco, index) {
