...
var SistemaOperativoController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'relaciones_clase': [{ 'idioma': ['id_idioma', 'nom_idioma'] }, { 'tipo_sistema_operativo': ['id_tipo_sistema_operativo', 'nom_tipo_sistema_operativo'] }],
         'lom': {},
         'lista_objs_model': [],
         'sistemas_operativos': [],
         'idiomas': [],
         ...
         'tabla_campos': {
            ...
            'arquitectura': { 'visibility': false, 'value': null },
            'nom_sistema_operativo': { 'visibility': true, 'value': null },
            'det_sistema_operativo': { 'visibility': false, 'value': null },
            'vers_sistema_operativo': { 'visibility': false, 'value': null },
            'lic_sistema_operativo': { 'visibility': false, 'value': null },
            'det_licencia_sistema_operativo': { 'visibility': false, 'value': null },
            //'id_idioma':{'visibility':false,'value':null},
            'nom_idioma': { 'visibility': false, 'value': null },
            //'id_tipo_sistema_operativo':{'visibility':false,'value':null},
            'nom_tipo_sistema_operativo': { 'visibility': false, 'value': null },
