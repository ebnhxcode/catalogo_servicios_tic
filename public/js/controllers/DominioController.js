...
var DominioController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['nom_dominio', 'det_dominio', 'ip_publica', 'ip_balanceador', 'dns_asoc_dominio'],
         'relaciones_clase': [],
         'lom': {},
         'lista_objs_model': [],
         'dominios': [],
         ...
         'tabla_campos': {
            ...
            'nom_dominio': { 'visibility': true, 'value': null },
            'det_dominio': { 'visibility': false, 'value': null },
            'ip_publica': { 'visibility': false, 'value': null },
            'ip_balanceador': { 'visibility': false, 'value': null },
            'dns_asoc_dominio': { 'visibility': false, 'value': null },
   ...
   watch: {
      ...
      dominios: function dominios(_dominios) {
         var self = this;
         this.excel_json_datos = [];
         return _dominios.map(function (dominio, index) {
