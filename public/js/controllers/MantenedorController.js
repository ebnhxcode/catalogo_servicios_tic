...
var MantenedorController = new Vue({
   ...
   data: function data() {
      return {
         ...
         'permitido_guardar': ['url_mantenedor', 'nom_mantenedor', 'det_mantenedor', 'cod_mantenedor', 'imagen_mantenedor', 'font_icon_mantenedor'],
         'relaciones_clase': [],
         'lom': {},
         'lista_objs_model': [],
         'mantenedores': [],
   ...
   watch: {
      ...
      mantenedores: function mantenedores(_mantenedores) {
         var self = this;
         this.excel_json_datos = [];
         return _mantenedores.map(function (mantenedor, index) {
